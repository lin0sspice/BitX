...
const string strMessageMagic = "BitX Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    if(pindexBest->nHeight == 1) // Premine 100k
    {
...
static const int64_t nTargetTimespan = 10* 60;  // every 10 blocks , 60 mins
//
...
// BitX: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "BitX", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "BitX";
        CTransaction txNew;
        txNew.nTime = 1422838888;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x725663c27c6c7174da90da16061e8a4062d3355bcbfc82971cf56506bd6e55f3"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0x56, 0x11, 0xad, 0xf4 };
